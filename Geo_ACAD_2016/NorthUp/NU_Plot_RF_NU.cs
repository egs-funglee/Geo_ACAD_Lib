...
namespace Geo_AC2016
{
	internal class NU_Plot_RF_NU
	{
		internal static void Plot_RF_NU()//for cutting
		{
			...
			double acad_textheight = double.Parse(str_pKeyRes);
				...
				foreach (RF iRF in lRF)
				{
					...
					switch (iRF.otype)
					{
						...
						case 2:
							...
							acText1.Justify = AttachmentPoint.MiddleCenter; acText1.Height = acad_textheight; acText1.TextString = iRF.annotation;
							acText2.Justify = AttachmentPoint.MiddleCenter; acText2.Height = acad_textheight; acText2.TextString = iRF.annotation;
							acText3.Justify = AttachmentPoint.MiddleCenter; acText3.Height = acad_textheight; acText3.TextString = iRF.annotation;
